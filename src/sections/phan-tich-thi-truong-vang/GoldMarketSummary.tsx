    ...
    <>
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, md: 5 }}>
          ...
          <Typography paragraph>
            Giá vàng SJC tại Phú Quý bật tăng trong tuần vừa qua, giao dịch trên mức{' '}
            <strong>153 triệu/lượng</strong> - mua vào, <strong>156 triệu/lượng</strong> - bán ra.
          </Typography>
      ...
      <Box component="table" sx={{ width: '100%', borderCollapse: 'collapse' }}>
        ...
        <Box component="tbody">
          ...
          <Box component="tr">
            <Box component="td" sx={tdStyle}>
              Vàng Thượng Hải giao tháng 02/2026
            </Box>
            <Box component="td" sx={tdStyle}>
              970 CNY/Gram
            </Box>
      ...
      <Typography paragraph>
        Giá vàng trong tuần vừa qua bật tăng mạnh mẽ nhờ đà suy yếu của USD. Bên cạnh đó, căng thẳng
        địa chính trị leo thang tiếp tục hỗ trợ giá vàng.
      </Typography>
    </>
  );
}
